...
public class ChartController {
    ...
    public BaseResponse<String> genChartByAI(@RequestPart("file") MultipartFile multipartFile,
        ...
        ThrowUtils.throwIf(StringUtils.isNotBlank(name)&&name.length()>=100, ErrorCode.PARAMS_ERROR,"名称不能过长");

        StringBuilder userInput = new StringBuilder();
        userInput.append("你作为一名数据分析师，接下来我将提供给你我的分析目标和原始数据，请告诉我分析结论。").append("\n");
